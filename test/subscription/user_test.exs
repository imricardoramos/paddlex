defmodule Paddle.Subscription.UserTest do
  use ExUnit.Case
  setup do
  ...
  test "lists users", %{bypass: bypass} do
    ...
    assert {:ok, [%Paddle.Subscription.User{
      subscription_id: 502198,
      plan_id: 496199,
      user_id: 285846,
      user_email: "name@example.com",
  ...
  test "update user", %{bypass: bypass} do
    ...
    }} == Paddle.Subscription.User.update(12345, params)
  end
  ...
  test "cancel_user", %{bypass: bypass} do
    ...
    assert {:ok, nil} == Paddle.Subscription.User.cancel(12345)
  end
